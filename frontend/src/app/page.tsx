...
type BackendEvent = { id: number; name: string; description?: string | null; start_time?: string | null; end_time?: string | null; location?: string | null; voting_enabled: boolean; voting_status?: "not_started" | "open" | "closed"; winner?: string | null };
